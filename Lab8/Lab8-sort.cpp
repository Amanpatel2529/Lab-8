...
void merging(int arr1[], int arr2[], int arr3[])
{
	int i=0, j=0, k=0;
	for (i = 0;i < 5 && j < 5;)
	{                              //compearing first array elements with second
		if (arr1[i] < arr2[j])
		{
			arr3[k] = arr1[i];
			k++;
	...
	while (i < 5)
	{                             //compearing for other elements of first and third arrays
		arr3[k] = arr1[i];
		k++;
		i++;
	}
	while (j < 5)
	{                            //compearing for other elements of second and third arrays
		arr3[k] = arr2[j];
		k++;
		j++;
	}
